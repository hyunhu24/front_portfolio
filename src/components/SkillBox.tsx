    ...
    return (
        <div className='flex flex-col gap-[50px]'>
            <div className='flex gap-[20px] items-center'>
                <img src={`${process.env.PUBLIC_URL}/assets/images/project/skillIcon/Idea.png`} alt="idea" />
                <div>
            ...
            <div className='flex gap-[20px] items-center'>
                <img src={`${process.env.PUBLIC_URL}/assets/images/project/skillIcon/Check.png`} alt="check" />
                <div>
                    {items.map((item, idx) => (
                        <div key={idx}>
